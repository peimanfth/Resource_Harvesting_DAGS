...
if __name__ == "__main__":
    ...
    update_Function("AES1", 2,4)
    update_Function("AES2", 2,4)
    update_Function("AES3", 2,4)
    result = invokeDAG(dag_ID, input)
    update_Function("AES1", 2,2)
    update_Function("AES2", 2,4)
    update_Function("AES3", 2,6)
    result = invokeDAG(dag_ID, input)
    update_Function("AES1", 2,1)
    update_Function("AES2", 2,3)
    update_Function("AES3", 2,8)
    result = invokeDAG(dag_ID, input)
    update_Function("AES1", 2,1)
    update_Function("AES2", 2,2)
    update_Function("AES3", 2,9)
    result = invokeDAG(dag_ID, input)
    update_Function("AES1", 2,1)
    update_Function("AES2", 2,1)
    update_Function("AES3", 2,1)
    result = invokeDAG(dag_ID, input)
