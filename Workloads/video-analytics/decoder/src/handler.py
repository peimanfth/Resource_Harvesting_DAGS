...
#     res = handler({'video_name': 'car', 'num_frames': 3, 'db_name': 'video-bench', 'doc_name': 'videos', 'request_ids': ['58fdb1e2-8565-4b3b-a083-244da2c861e9-recog11', '58fdb1e2-8565-4b3b-a083-244da2c861e9-recog22']})
#     print(res)
