...
wsk -i action update paramtune0 --kind python:3.10 --main main --memory $mem4 --timeout $timeout index.zip -p index 0
...
wsk -i action update paramtune1 --kind python:3.10 --main main --memory $mem3 --timeout $timeout index.zip -p index 1
...
wsk -i action update paramtune2 --kind python:3.10 --main main --memory $mem2 --timeout $timeout index.zip -p index 2
...
wsk -i action update paramtune3 --kind python:3.10 --main main --memory $mem1 --timeout $timeout index.zip -p index 3
